...
const registerUser = asyncHandler(async (req, res) => {
  ...
  //? validate them
  //? use if user already exists: username, email
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //? find the user
  //? password check
  //? access and refresh token generate both and give it to user
  //? send cookie
...
const getWatchHistory = asyncHandler(async (req, res) => {
  //? using user._id you will get the string
  //?you need to convert it into mongodb it to use it which is done by mongoose
